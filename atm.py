...
balance = 10000
# 사용하기 위해 만드는것, 초기화 특정값을 넣어서 만들거나, 빈 값을 넣어서 만듭니다.
# 무한루프? while vs for
receipts = []
...
while True:
    ...
    if num == '2':
        ...
        withdraw_amount = min(balance,withdraw_amount) #min(10000, 300000) -> 10000
        balance -= withdraw_amount # balance = 10000 - withdraw_amount(5000)
        print(f'출금하실 금액은{withdraw_amount}원이고, 현재 잔액은 {balance}원 입니다.')
